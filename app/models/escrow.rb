class Escrow < ApplicationRecord
    ...
    def generate_checksum
        data = "#{buyer_email}|#{buyer_name}|#{shipping_attention}|#{""}|#{transaction_number}|#{description}|http://#{ENV["domain"]}/users/escrows/paymentredirect|#{total_pay}|#{"02b66d73-c60f-47e6-a07c-0aa3609ddddd"}"
        puts(data)
